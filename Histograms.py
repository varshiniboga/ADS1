# -*- coding: utf-8 -*-
"""
Created on Tue Nov  7 19:45:23 2023
...
if response.status_code == 200:
    ...
    # Create a histogram of the GDP data
    plt.figure(figsize=(10, 6))
    plt.hist(df['GDP'], bins=20, edgecolor='k')
    plt.title("GDP Histogram for {}".format(country_code))
